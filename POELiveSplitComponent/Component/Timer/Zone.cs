...
namespace POELiveSplitComponent.Component.Timer
{
    public class Zone : IZone
    {
        ...
        static Zone()
        {
            ...
            add(new Zone("습지대", 2), IconType.NoWp, act6Home);
            ...
            add(new Zone("공포의 잡목림", 2), IconType.NoWp, act7Home);
            ...
            add(new Zone("솔라리스 중앙 광장", 2), IconType.Wp, act8Home);
            add(new Zone("목욕탕", 2), IconType.Wp, act8Home);
            add(new Zone("고층 정원", 2), IconType.NoWp, act8Home);
            ...
            add(new Zone("오아시스", 2), IconType.NoWp, act9Home);
